...
namespace RDLinker.Logging.Provider
{
    public class Log4NetLogger : ILogger
    {
        ...
        {
            string path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config/log4netconfig.xml");
            //初始化配置文件
